...
import in.tailor.digi.shop.repository.AddressRepository;
import in.tailor.digi.shop.repository.ShopRepository;
import in.tailor.digi.shop.repository.UserShopMappingRepository;
...
public non-sealed class ShopServiceImpl implements ShopService {
    ...
    public Optional<Shop> addShop(Shop shop) {
        shop.setShopId(DtsUtils.generateShopId());
        shop.setShopCode(DtsUtils.generateShopCode());
        if (shop.getShopAddress() != null) {
            shop.getShopAddress().setAddressId(DtsUtils.generateAddressId());
